export const Bio = {
  ...
  description:
    "I am a dedicated and innovative professional with a robust background in ReactJS, contributing 2+ years of expertise in crafting dynamic and responsive user interfaces. Eagerly expanding skills to encompass Node.js and Express for a comprehensive MERN stack proficiency. Proven track record in collaborative environments, effectively communicating technical concepts, and contributing positively to project success. Actively pursuing opportunities to apply refined ReactJS skills while gaining valuable experience in backend development. Committed to delivering high-quality code and continuous learning.",
...
export const skills = [
  ...
  },
  {
    ...
    skills: [
      ...
      {
        name: "SQL",
        image: "https://cdn1.vectorstock.com/i/1000x1000/77/30/sql-database-icon-logo-design-ui-or-ux-app-vector-17507730.jpg",
      },
    ],
  },
  {
...
export const experiences = [
  {
    ...
    desc: "The project showcases a web application designed to promote Hyper Automaton.The main purpose of Migration Manager tool is that a User can check the allocated Licenses, Account Creation, Assigning of Policies, Validating Policies, Checking Dial Plan, Voice Policies etc.",
    skills: [
      "ReactJs",
      "Bootstrap",
      "Material UI",
  ...
  },
  {
    ...
    desc: "Working as Systems Engineer at Infosys & responsible for designing, developing, and maintaining the systems that support the company's operations. This includes working on infrastructure design, deployment, and maintenance projects, as well as troubleshooting and problem-solving when issues arise",
    skills: [
      "HTML",
      "CSS",
      "Bootstrap",
...
export const education = [
  {
    id: 0,
    img: "https://upload.wikimedia.org/wikipedia/commons/f/f7/Logo_PSIT.jpg",
